(() => {
  ...
  const translations = {
    ar: {
      "Want my resume? Contact me": "هل تريد سيرتي الذاتية؟ تواصل معي",
      "I build dependable backend and data systems that teams can trust and grow with.": "أبني أنظمة خلفية ومنصات بيانات موثوقة يمكن للفرق الاعتماد عليها والتوسع معها.",
      "Backend, Data & Intelligent Systems": "الأنظمة الخلفية والبيانات والأنظمة الذكية",
      "8+ years building backend services, data platforms, and intelligent systems that stay useful, reliable, and ready for production.": "أكثر من 8 سنوات في بناء خدمات خلفية ومنصات بيانات وأنظمة ذكية تظل عملية وموثوقة وجاهزة للإنتاج.",
      "My work sits across software engineering, data engineering, and AI. I have built backend services, data platforms, streaming and batch pipelines, analytics workflows, and early-stage AI products across fintech, cybersecurity, real estate, and intelligent transportation. I enjoy moving between these areas, understanding the business behind the system, and turning complex requirements into dependable products and trustworthy data that teams can confidently build on.": "يمتد عملي بين هندسة البرمجيات وهندسة البيانات والذكاء الاصطناعي. بنيت خدمات خلفية ومنصات بيانات ومسارات معالجة فورية ودفعية وتدفقات تحليلية ومنتجات ذكاء اصطناعي في مراحلها المبكرة ضمن قطاعات التكنولوجيا المالية والأمن السيبراني والعقارات والنقل الذكي. أستمتع بالعمل بين هذه المجالات وفهم الجانب التجاري للنظام وتحويل المتطلبات المعقدة إلى منتجات موثوقة وبيانات يمكن للفرق البناء عليها بثقة.",
      "The toolkit behind my backend, data, cloud, and AI work.": "مجموعة الأدوات والممارسات التي أعتمد عليها في أعمال الأنظمة الخلفية والبيانات والسحابة والذكاء الاصطناعي.",
      "A career built around backend engineering, data platforms, and dependable production systems.": "مسيرة مهنية تتمحور حول هندسة الأنظمة الخلفية ومنصات البيانات وأنظمة إنتاج موثوقة.",
      "Senior software engineer with a strong data engineering focus, building reliable data platforms, pipelines, analytical models, and backend services. Experienced in data quality, governance, warehousing, real-time processing, and cloud delivery, with the flexibility to contribute across backend and data engineering roles.": "مهندس برمجيات أول بتركيز قوي على هندسة البيانات، أعمل على بناء منصات بيانات موثوقة ومسارات معالجة ونماذج تحليلية وخدمات خلفية. لدي خبرة في جودة البيانات والحوكمة ومستودعات البيانات والمعالجة اللحظية والتسليم السحابي، مع القدرة على المساهمة بمرونة في أدوار هندسة الأنظمة الخلفية وهندسة البيانات.",
      "Backend Engineer, Security Systems": "مهندس أنظمة خلفية، أنظمة أمنية",
      "At Charisma, I worked on the data and backend foundation behind a large financial portfolio platform used across product, analytics, and engineering teams. My role covered data pipelines, shared models, streaming workflows, analytical systems, and platform delivery, with a strong focus on making data easier to trust, access, and build on. I also supported teammates through code reviews and mentoring, helped improve engineering practices, and contributed to early AI and RAG initiatives that explored new ways to work with internal data.": "في كاريزما، عملت على الأساس البياني والخلفي لمنصة مالية كبيرة للمحافظ تستخدمها فرق المنتج والتحليلات والهندسة. شمل دوري مسارات البيانات والنماذج المشتركة والتدفقات اللحظية والأنظمة التحليلية وتسليم المنصة، مع تركيز واضح على جعل البيانات أكثر موثوقية وسهولة في الوصول والبناء عليها. كما دعمت زملائي عبر مراجعات الكود والإرشاد، وساهمت في تحسين الممارسات الهندسية ومبادرات مبكرة للذكاء الاصطناعي وRAG لاكتشاف طرق جديدة للاستفادة من البيانات الداخلية.",
      "At Bithome, I was part of a small team building and improving a real-estate crowdfunding platform from the ground up. I worked across customer-facing services, internal operations tools, background processing, database performance, and testing, often moving between product needs and technical improvements. A big part of the role was simplifying slow or manual workflows, making the platform more dependable, and giving both customers and internal teams a smoother day-to-day experience.": "في Bithome، كنت ضمن فريق صغير يبني ويطوّر منصة للتمويل الجماعي العقاري من البداية. عملت على خدمات العملاء والأدوات التشغيلية الداخلية والمعالجة الخلفية وأداء قواعد البيانات والاختبارات، مع التنقل باستمرار بين احتياجات المنتج والتحسينات التقنية. كان جزء مهم من دوري تبسيط الإجراءات البطيئة أو اليدوية، ورفع موثوقية المنصة، وتحسين التجربة اليومية للعملاء والفرق الداخلية.",
      "At Andisheh Negar Pars, I worked on a distributed security platform designed to monitor, manage, and protect systems across a large environment. My work included backend services, real-time monitoring, alert investigation, deployment reliability, and operational tooling, in close collaboration with security and infrastructure teams. The experience strengthened my ability to understand complex systems end to end, investigate issues carefully, and build services that remain reliable under demanding production conditions.": "في أنديشه نگار پارس، عملت على منصة أمنية موزعة لمراقبة الأنظمة وإدارتها وحمايتها ضمن بيئة واسعة. شمل عملي الخدمات الخلفية والمراقبة اللحظية والتحقيق في التنبيهات وموثوقية النشر والأدوات التشغيلية، بالتعاون الوثيق مع فرق الأمن والبنية التحتية. عززت هذه التجربة قدرتي على فهم الأنظمة المعقدة من البداية إلى النهاية، وتحليل المشكلات بعناية، وبناء خدمات تبقى موثوقة في ظروف إنتاج تتطلب الكثير.",
      "At PFK, I worked on intelligent transportation systems where software had to connect reliably with real-world infrastructure. My responsibilities spanned camera software, distributed image processing, databases, and data-center systems supporting traffic-monitoring operations across multiple cities. It was an early opportunity to work on large, always-on systems and taught me how to think beyond individual components, understand how the full system behaves, and keep production services dependable over time.": "في PFK، عملت على أنظمة نقل ذكية كان على البرمجيات فيها أن تتكامل بشكل موثوق مع بنية تحتية حقيقية. شملت مسؤولياتي برمجيات الكاميرات ومعالجة الصور الموزعة وقواعد البيانات وأنظمة مراكز البيانات التي تدعم مراقبة المرور عبر عدة مدن. كانت تجربة مبكرة مع أنظمة كبيرة تعمل باستمرار، وعلمتني التفكير فيما يتجاوز المكونات الفردية وفهم سلوك النظام بالكامل والحفاظ على موثوقية خدمات الإنتاج مع مرور الوقت.",
      "Selected work that made systems faster, data more useful, and teams more effective.": "نماذج من أعمال جعلت الأنظمة أسرع والبيانات أكثر فائدة والفرق أكثر فاعلية.",
      "Data Platform at Million-User Scale": "منصة بيانات على نطاق مليون مستخدم",
      "Helped build the real-time data and service foundation behind a portfolio platform serving 1M+ users and multiple product and analytics teams.": "ساهمت في بناء الأساس اللحظي للبيانات والخدمات وراء منصة محافظ تخدم أكثر من مليون مستخدم وتدعم فرقاً متعددة في المنتج والتحليلات.",
      "80% Faster Analytics on 500M+ Records": "تحليلات أسرع بنسبة 80٪ على أكثر من 500 مليون سجل",
      "Reshaped large SQL and BigQuery models across 500M+ records, reducing query latency by 80% and making analytical workloads faster and easier to operate.": "أعدت تصميم نماذج SQL وBigQuery واسعة النطاق على أكثر من 500 مليون سجل، ما خفّض زمن الاستعلامات بنسبة 80٪ وجعل أحمال التحليلات أسرع وأسهل في التشغيل.",
      "Security Platform Across 1,000+ Nodes": "منصة أمنية عبر أكثر من 1000 عقدة",
      "Built core parts of a distributed security agent and helped grow a 25+ service platform for monitoring, remote operations, and secure management across 1,000+ nodes.": "بنيت أجزاء أساسية من وكيل أمني موزع وساهمت في تطوير منصة تضم أكثر من 25 خدمة للمراقبة والعمليات عن بعد والإدارة الآمنة عبر أكثر من 1000 عقدة.",
      "20M+ Records a Day into the Lakehouse": "أكثر من 20 مليون سجل يومياً إلى الـ Lakehouse",
      "Built Azure Data Factory and Databricks pipelines processing more than 20M records daily into a lakehouse, powering Power BI and shared analytics for 5+ teams.": "بنيت مسارات Azure Data Factory وDatabricks تعالج أكثر من 20 مليون سجل يومياً داخل Lakehouse وتغذي Power BI وتحليلات مشتركة لأكثر من 5 فرق.",
      "Nationwide Traffic Data Infrastructure": "بنية بيانات لحركة المرور على نطاق واسع",
      "Supported 1,200+ traffic cameras across 28+ cities and helped architect a distributed Python system processing more than 100 images every second.": "دعمت أكثر من 1200 كاميرا مرور عبر أكثر من 28 مدينة وساهمت في تصميم نظام Python موزع يعالج أكثر من 100 صورة كل ثانية.",
      "From Data to an Evaluated AI Assistant": "من البيانات إلى مساعد ذكاء اصطناعي مُقيّم",
      "Prototyped an LLM and RAG assistant across 10+ datasets with a focused evaluation suite for quality, latency, and failure handling, connecting data engineering with practical AI delivery.": "طورت نموذجاً أولياً لمساعد يعتمد على LLM وRAG عبر أكثر من 10 مجموعات بيانات، مع مجموعة تقييم تركز على الجودة وزمن الاستجابة والتعامل مع الإخفاقات، لربط هندسة البيانات بتطبيقات عملية للذكاء الاصطناعي.",
      "Where backend engineering, data platforms, AI, and reliable production systems come together.": "حيث تلتقي هندسة الأنظمة الخلفية ومنصات البيانات والذكاء الاصطناعي وأنظمة الإنتاج الموثوقة.",
      "Python, FastAPI, Django, REST and GraphQL APIs, DDD, design patterns, microservices, and maintainable service architecture.": "Python وFastAPI وDjango وواجهات REST وGraphQL وDDD وأنماط التصميم والخدمات المصغرة وهندسة خدمات سهلة الصيانة.",
      "Airflow, dbt, ETL/ELT, data governance, modeling, warehousing, lakehouse patterns, CDC, and shared data platforms for operational and analytical workloads.": "Airflow وdbt وETL/ELT وحوكمة البيانات ونمذجتها ومستودعات البيانات وأنماط Lakehouse وCDC ومنصات البيانات المشتركة للأحمال التشغيلية والتحليلية.",
      "Kafka, RabbitMQ, Redis, Celery, Debezium, event-driven architecture, and distributed processing for systems that need to react and recover gracefully.": "Kafka وRabbitMQ وRedis وCelery وDebezium والهندسة القائمة على الأحداث والمعالجة الموزعة للأنظمة التي تحتاج إلى الاستجابة والتعافي بسلاسة.",
      "Query optimization, data quality, observability, monitoring, automated testing, debugging, and the practical work of keeping production systems healthy.": "تحسين الاستعلامات وجودة البيانات وقابلية المراقبة والمراقبة التشغيلية والاختبارات الآلية وتصحيح الأخطاء والعمل العملي للحفاظ على صحة أنظمة الإنتاج.",
      "Docker, Kubernetes, Terraform, Helm, CI/CD, Linux, AWS, Azure, and GCP for repeatable deployments and dependable platform operations.": "Docker وKubernetes وTerraform وHelm وCI/CD وLinux وAWS وAzure وGCP لعمليات نشر قابلة للتكرار وتشغيل منصات موثوق.",
      "ML pipelines, RAG, LLM applications, AI-assisted analytics, prompt engineering, and AI agents, used as practical tools inside real products and workflows.": "مسارات ML وRAG وتطبيقات LLM والتحليلات المدعومة بالذكاء الاصطناعي وهندسة الأوامر ووكلاء الذكاء الاصطناعي كأدوات عملية داخل منتجات وتدفقات عمل حقيقية.",
      "A few words from the people I’ve had the chance to build, troubleshoot, learn, and grow alongside.": "بضع كلمات من أشخاص حظيت بفرصة البناء وحل المشكلات والتعلم والتطور إلى جانبهم.",
      "Open to thoughtful teams building meaningful products across backend, data, and AI. Always happy to connect.": "مهتم بالعمل مع فرق طموحة تبني منتجات ذات معنى في الأنظمة الخلفية والبيانات والذكاء الاصطناعي، ويسعدني دائماً التواصل.",
      "Portfolio visitors": "زوار الموقع",
    ...
    tr: {
      "Want my resume? Contact me": "Özgeçmişimi ister misiniz? Benimle iletişime geçin",
      "I build dependable backend and data systems that teams can trust and grow with.": "Ekiplerin güvenebileceği ve birlikte büyütebileceği sağlam backend ve veri sistemleri geliştiriyorum.",
      "Backend, Data & Intelligent Systems": "Backend, Veri ve Akıllı Sistemler",
      "8+ years building backend services, data platforms, and intelligent systems that stay useful, reliable, and ready for production.": "8+ yıldır kullanışlı, güvenilir ve üretime hazır backend servisleri, veri platformları ve akıllı sistemler geliştiriyorum.",
      "My work sits across software engineering, data engineering, and AI. I have built backend services, data platforms, streaming and batch pipelines, analytics workflows, and early-stage AI products across fintech, cybersecurity, real estate, and intelligent transportation. I enjoy moving between these areas, understanding the business behind the system, and turning complex requirements into dependable products and trustworthy data that teams can confidently build on.": "Çalışmalarım yazılım mühendisliği, veri mühendisliği ve yapay zekânın kesişiminde yer alıyor. Fintech, siber güvenlik, gayrimenkul ve akıllı ulaşım alanlarında backend servisleri, veri platformları, streaming ve batch pipeline'ları, analitik iş akışları ve erken aşama AI ürünleri geliştirdim. Bu alanlar arasında hareket etmeyi, sistemin arkasındaki işi anlamayı ve karmaşık gereksinimleri ekiplerin güvenle üzerine inşa edebileceği sağlam ürünlere ve güvenilir verilere dönüştürmeyi seviyorum.",
      "The toolkit behind my backend, data, cloud, and AI work.": "Backend, veri, bulut ve AI çalışmalarımın arkasındaki araçlar ve pratikler.",
      "A career built around backend engineering, data platforms, and dependable production systems.": "Backend mühendisliği, veri platformları ve güvenilir üretim sistemleri etrafında şekillenen bir kariyer.",
      "Senior software engineer with a strong data engineering focus, building reliable data platforms, pipelines, analytical models, and backend services. Experienced in data quality, governance, warehousing, real-time processing, and cloud delivery, with the flexibility to contribute across backend and data engineering roles.": "Veri mühendisliğine güçlü şekilde odaklanan kıdemli yazılım mühendisi. Güvenilir veri platformları, pipeline'lar, analitik modeller ve backend servisleri geliştiriyorum. Veri kalitesi, yönetişim, veri ambarı, gerçek zamanlı işleme ve bulut teslimatı konularında deneyimliyim; hem backend hem de veri mühendisliği rollerinde etkin şekilde katkı sağlayabilirim.",
      "Backend Engineer, Security Systems": "Backend Mühendisi, Güvenlik Sistemleri",
      "At Charisma, I worked on the data and backend foundation behind a large financial portfolio platform used across product, analytics, and engineering teams. My role covered data pipelines, shared models, streaming workflows, analytical systems, and platform delivery, with a strong focus on making data easier to trust, access, and build on. I also supported teammates through code reviews and mentoring, helped improve engineering practices, and contributed to early AI and RAG initiatives that explored new ways to work with internal data.": "Charisma'da ürün, analitik ve mühendislik ekiplerinin kullandığı büyük bir finansal portföy platformunun veri ve backend temelinde çalıştım. Rolüm veri pipeline'ları, paylaşılan modeller, streaming iş akışları, analitik sistemler ve platform teslimatını kapsıyordu. Ana odağım veriyi daha güvenilir, erişilebilir ve üzerine geliştirme yapılabilir hale getirmekti. Kod incelemeleri ve mentorlukla ekip arkadaşlarımı destekledim, mühendislik pratiklerinin gelişmesine katkı sağladım ve kurum içi verilerle yeni çalışma yollarını araştıran erken dönem AI ve RAG girişimlerinde yer aldım.",
      "At Bithome, I was part of a small team building and improving a real-estate crowdfunding platform from the ground up. I worked across customer-facing services, internal operations tools, background processing, database performance, and testing, often moving between product needs and technical improvements. A big part of the role was simplifying slow or manual workflows, making the platform more dependable, and giving both customers and internal teams a smoother day-to-day experience.": "Bithome'da gayrimenkul crowdfunding platformunu sıfırdan geliştiren ve iyileştiren küçük bir ekibin parçasıydım. Müşteriye dönük servisler, iç operasyon araçları, arka plan işlemleri, veritabanı performansı ve testler üzerinde çalıştım; ürün ihtiyaçları ile teknik iyileştirmeler arasında sık sık köprü kurdum. Rolün önemli bir kısmı yavaş veya manuel süreçleri sadeleştirmek, platformu daha güvenilir hale getirmek ve hem müşteriler hem de iç ekipler için günlük kullanımı kolaylaştırmaktı.",
      "At Andisheh Negar Pars, I worked on a distributed security platform designed to monitor, manage, and protect systems across a large environment. My work included backend services, real-time monitoring, alert investigation, deployment reliability, and operational tooling, in close collaboration with security and infrastructure teams. The experience strengthened my ability to understand complex systems end to end, investigate issues carefully, and build services that remain reliable under demanding production conditions.": "Andisheh Negar Pars'ta geniş bir ortamda sistemleri izlemek, yönetmek ve korumak için tasarlanmış dağıtık bir güvenlik platformunda çalıştım. Backend servisleri, gerçek zamanlı izleme, alarm inceleme, deployment güvenilirliği ve operasyon araçları üzerinde güvenlik ve altyapı ekipleriyle yakın çalıştım. Bu deneyim, karmaşık sistemleri uçtan uca anlama, sorunları dikkatle inceleme ve zorlu üretim koşullarında güvenilir kalan servisler geliştirme yeteneğimi güçlendirdi.",
      "At PFK, I worked on intelligent transportation systems where software had to connect reliably with real-world infrastructure. My responsibilities spanned camera software, distributed image processing, databases, and data-center systems supporting traffic-monitoring operations across multiple cities. It was an early opportunity to work on large, always-on systems and taught me how to think beyond individual components, understand how the full system behaves, and keep production services dependable over time.": "PFK'da yazılımın gerçek dünya altyapısıyla güvenilir biçimde çalışması gereken akıllı ulaşım sistemleri üzerinde çalıştım. Sorumluluklarım kamera yazılımı, dağıtık görüntü işleme, veritabanları ve birden fazla şehirde trafik izleme operasyonlarını destekleyen veri merkezi sistemlerini kapsıyordu. Büyük ve sürekli çalışan sistemlerle erken dönemde çalışma fırsatı buldum; bu deneyim bana tek tek bileşenlerin ötesini düşünmeyi, tüm sistemin davranışını anlamayı ve üretim servislerini zaman içinde güvenilir tutmayı öğretti.",
      "Selected work that made systems faster, data more useful, and teams more effective.": "Sistemleri hızlandıran, veriyi daha kullanışlı hale getiren ve ekiplerin daha etkili çalışmasını sağlayan seçili işler.",
      "Data Platform at Million-User Scale": "Milyon Kullanıcı Ölçeğinde Veri Platformu",
      "Helped build the real-time data and service foundation behind a portfolio platform serving 1M+ users and multiple product and analytics teams.": "1 milyon+ kullanıcıya hizmet veren ve birden fazla ürün ile analitik ekibini destekleyen portföy platformunun gerçek zamanlı veri ve servis temelinin geliştirilmesine katkı sağladım.",
      "80% Faster Analytics on 500M+ Records": "500M+ Kayıtta %80 Daha Hızlı Analitik",
      "Reshaped large SQL and BigQuery models across 500M+ records, reducing query latency by 80% and making analytical workloads faster and easier to operate.": "500 milyon+ kayıt üzerinde büyük SQL ve BigQuery modellerini yeniden düzenleyerek sorgu gecikmesini %80 azalttım ve analitik iş yüklerini daha hızlı ve daha kolay işletilir hale getirdim.",
      "Security Platform Across 1,000+ Nodes": "1.000+ Node Üzerinde Güvenlik Platformu",
      "Built core parts of a distributed security agent and helped grow a 25+ service platform for monitoring, remote operations, and secure management across 1,000+ nodes.": "Dağıtık bir güvenlik ajanının temel parçalarını geliştirdim ve 1.000+ node üzerinde izleme, uzaktan operasyon ve güvenli yönetim sağlayan 25+ servislik platformun büyümesine katkı sağladım.",
      "20M+ Records a Day into the Lakehouse": "Lakehouse'a Günde 20M+ Kayıt",
      "Built Azure Data Factory and Databricks pipelines processing more than 20M records daily into a lakehouse, powering Power BI and shared analytics for 5+ teams.": "Günde 20 milyon+ kaydı lakehouse'a işleyen Azure Data Factory ve Databricks pipeline'ları geliştirdim; bunlar Power BI'ı ve 5+ ekip için paylaşılan analitiği besledi.",
      "Nationwide Traffic Data Infrastructure": "Geniş Ölçekli Trafik Veri Altyapısı",
      "Supported 1,200+ traffic cameras across 28+ cities and helped architect a distributed Python system processing more than 100 images every second.": "28+ şehirde 1.200+ trafik kamerasını destekledim ve saniyede 100'den fazla görüntü işleyen dağıtık Python sisteminin mimarisine katkı sağladım.",
      "From Data to an Evaluated AI Assistant": "Veriden Değerlendirilmiş Bir AI Asistanına",
      "Prototyped an LLM and RAG assistant across 10+ datasets with a focused evaluation suite for quality, latency, and failure handling, connecting data engineering with practical AI delivery.": "10+ veri seti üzerinde LLM ve RAG tabanlı bir asistan prototipi geliştirdim; kalite, gecikme ve hata yönetimine odaklanan değerlendirme setiyle veri mühendisliğini pratik AI teslimatıyla birleştirdim.",
      "Where backend engineering, data platforms, AI, and reliable production systems come together.": "Backend mühendisliği, veri platformları, AI ve güvenilir üretim sistemlerinin kesiştiği alanlar.",
      "Python, FastAPI, Django, REST and GraphQL APIs, DDD, design patterns, microservices, and maintainable service architecture.": "Python, FastAPI, Django, REST ve GraphQL API'leri, DDD, tasarım kalıpları, mikroservisler ve sürdürülebilir servis mimarisi.",
      "Airflow, dbt, ETL/ELT, data governance, modeling, warehousing, lakehouse patterns, CDC, and shared data platforms for operational and analytical workloads.": "Airflow, dbt, ETL/ELT, veri yönetişimi, modelleme, veri ambarı, lakehouse yaklaşımları, CDC ve operasyonel/analitik iş yükleri için paylaşılan veri platformları.",
      "Kafka, RabbitMQ, Redis, Celery, Debezium, event-driven architecture, and distributed processing for systems that need to react and recover gracefully.": "Kafka, RabbitMQ, Redis, Celery, Debezium, event-driven mimari ve hızlı tepki verip sağlıklı biçimde toparlanması gereken sistemler için dağıtık işleme.",
      "Query optimization, data quality, observability, monitoring, automated testing, debugging, and the practical work of keeping production systems healthy.": "Sorgu optimizasyonu, veri kalitesi, observability, monitoring, otomatik testler, debugging ve üretim sistemlerini sağlıklı tutmaya yönelik pratik çalışmalar.",
      "Docker, Kubernetes, Terraform, Helm, CI/CD, Linux, AWS, Azure, and GCP for repeatable deployments and dependable platform operations.": "Tekrarlanabilir deployment'lar ve güvenilir platform operasyonları için Docker, Kubernetes, Terraform, Helm, CI/CD, Linux, AWS, Azure ve GCP.",
      "ML pipelines, RAG, LLM applications, AI-assisted analytics, prompt engineering, and AI agents, used as practical tools inside real products and workflows.": "Gerçek ürün ve iş akışlarında pratik araçlar olarak kullanılan ML pipeline'ları, RAG, LLM uygulamaları, AI destekli analitik, prompt engineering ve AI agent'ları.",
      "A few words from the people I’ve had the chance to build, troubleshoot, learn, and grow alongside.": "Birlikte geliştirme yaptığım, sorun çözdüğüm, öğrendiğim ve geliştiğim kişilerden birkaç söz.",
      "Open to thoughtful teams building meaningful products across backend, data, and AI. Always happy to connect.": "Backend, veri ve AI alanlarında anlamlı ürünler geliştiren güçlü ekiplerle tanışmaya açığım. Her zaman iletişim kurmaktan memnuniyet duyarım.",
      "Portfolio visitors": "Portföy ziyaretçileri",
